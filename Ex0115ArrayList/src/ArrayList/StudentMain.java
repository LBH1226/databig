...
//		Student stu = new Student("김동완", 28);
//		sList.add(stu);
		sList.add(new Student("김동완", 28));
		...
		// 4. 팀원 데이터를 전부 추가하기
		sList.add(new Student("김동현", 29));
		sList.add(new Student("이지훈", 29));
		sList.add(new Student("강아람", 29));
		sList.add(new Student("박종현", 29));
